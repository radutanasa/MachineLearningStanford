...
% we transform each output into a vector, so we end up with a matrix
% if y(i) is 5, then Y(i) will be [0 0 0 0 1 0 ... 0]
I = eye(num_labels);
...
Sigma3 = A3 - Y;
% we do not include sigma zero (index 1 in octave)
